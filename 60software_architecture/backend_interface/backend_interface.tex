...
\begin{document}
	...
	\begin{tcolorbox}[tab2,tabularx={X||Y|Y|Y|Y||Y},title=Complete overview of back-end endpoints. P stands for parameter,boxrule=0.5pt]
		...
		sp/p/qualification & an array of qualifications \\\hline
		semester/p/modules  & an array of modules  \\\hline
		semester/p/qualifications   & an array of qualifications \\\hline
		curriculum/:curriculum\_id/semesters  & an array of semesters  \\\hline
		module/p/lg  & an array of learning goals 
	\end{tcolorbox}
