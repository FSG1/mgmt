...
\begin{goal}{Independently create good software}
	...
	\Criteria{If the team finds my independently created code useful}
\end{goal}
...
\begin{goal}{Understandable software}
	...
	\Criteria{If my team finds the code and documentation understandable.}
\end{goal}

\begin{goal}{Improve software structuring}
	\Description{Having a good software structure can help fining certain code documents faster. Putting similar documents together creates a natural feel of where to find something and thus shorten searching time.}
	...
	\Criteria{Theres success when feedback at the end is lower than at the beginning.}
	\Criteria{If the team finds my way of structuring useful.}
\end{goal}